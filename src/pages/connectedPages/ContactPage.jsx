    ...
    <div className={styles.page}>
      ...
      <div className={styles.inner}>
        ...
        <motion.div className={styles.header} {...fadeUp(0)}>
          <h1 className={styles.title}>Travaillons <span className={styles.accent}>Ensemble</span></h1>
          <p className={styles.subtitle}>
            Vous avez un projet en tête ? Je suis actuellement disponible pour des opportunités à temps plein. Créons ensemble quelque chose d'exceptionnel.
          </p>
        </motion.div>
        ...
        <div className={styles.layout}>
            ...
            <Form form={form} layout="vertical" onFinish={handleSubmit} requiredMark={false}>
              <div className={styles.formRow}>
                <Form.Item name="name" label="Nom" rules={[{ required: true, message: 'Requis' }]}>
                  <Input placeholder="Noel Delafosse" className={styles.input} />
                </Form.Item>
                <Form.Item name="email" label="Email" rules={[{ required: true, type: 'email', message: 'Email valide requis' }]}>
                  <Input placeholder="noel@example.com" className={styles.input} />
                </Form.Item>
              </div>
              <Form.Item name="subject" label="Objet" rules={[{ required: true, message: 'Requis' }]}>
                <Input placeholder="Collaboration pour un projet, remerciements..." className={styles.input} />
              </Form.Item>
              <Form.Item name="message" label="Message" rules={[{ required: true, message: 'Requis' }, { min: 10, message: '10 caractères minimum' }]}>
                <TextArea placeholder="Parlez-moi de votre projet..." rows={5} className={styles.input} />
              </Form.Item>
          ...
          <motion.div className={styles.infoCol} {...fadeUp(0.18)}>
            <div className={styles.availCard}>
              ...
              <div>
                <div className={styles.availTitle}>Disponible maintenant</div>
                <div className={styles.availSub}>Temps de réponse : -24h</div>
              </div>
            </div>
            <div className={styles.locationCard}>
              ...
              <div>
                ...
                <div className={styles.locSub}>Télétravail (Remote) / Présentiel</div>
              </div>
            </div>
            <div className={styles.socialSection}>
              <div className={styles.socialLabel}>Me retrouver en ligne</div>
