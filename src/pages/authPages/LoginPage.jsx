  ...
  return (
    <div className={styles.authRoot}>
      ...
      <motion.aside className={styles.panel} initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}>
        ...
        <Link to="/" className={styles.panelLogo}><div className={styles.panelLogoIcon}> <img src={monfolio_logo} alt="" style={styles.panelLogoImgage} /> </div><span>MonFolio</span></Link>
